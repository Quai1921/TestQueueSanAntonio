...
public class ConfiguracionPantalla {
    ...
    @Column(name = "tema_color", length = 20)
    @Builder.Default
    private String temaColor = "default"; // "default", "dark", "municipal", etc.

    @Column(name = "mostrar_logo", nullable = false)
    @Builder.Default
    private Boolean mostrarLogo = true;

    @Column(name = "ruta_logo", length = 200)
     ...
     * @param tema tema de color
     * @param mostrarLogo si mostrar logo
     * @param rutaLogo ruta del logo
     */
    public void configurarApariencia(Boolean animaciones, String tema,
                                     Boolean mostrarLogo, String rutaLogo) {
