...
public class ConfiguracionPantallaController {
    ...
    public ResponseEntity<ApiResponseWrapper<ConfiguracionPantallaResponse>> crearConfiguracion(
        ...
        // Configurar apariencia si se especifica
        if (request.getTemaColor() != null ||
                request.getMostrarLogo() != null ||
                request.getRutaLogo() != null) {

            configuracionPantallaService.configurarApariencia(
                    configuracion.getId(),
                    request.getTemaColor() != null ? request.getTemaColor() : configuracion.getTemaColor(),
                    request.getMostrarLogo() != null ? request.getMostrarLogo() : configuracion.getMostrarLogo(),
                    request.getRutaLogo() != null ? request.getRutaLogo() : configuracion.getRutaLogo()
            );
        }
    ...
    public ResponseEntity<ApiResponseWrapper<ConfiguracionPantallaResponse>> actualizarConfiguracion(
        ...
        if (request.getTemaColor() != null ||
            ...
            configuracionPantallaService.configurarApariencia(
                    id,
                    request.getTemaColor(),
                    request.getMostrarLogo(),
                    request.getRutaLogo()
            );
        }
    ...
    public ResponseEntity<ApiResponseWrapper<String>> configurarApariencia(
        ...
        log.info("Configurando apariencia para configuración ID: {} - Tema: {}", id, request.getTema());
        ...
        log.debug("Apariencia configurada para configuración ID: {}", id);

        return ResponseEntity.ok(
                ApiResponseWrapper.success("OK", "Apariencia configurada exitosamente")
        );
    }
}