...
public class ConfiguracionPantallaMapper {
    ...
    public static ConfiguracionPantalla toEntity(ConfiguracionPantallaRequest request) {
        ...
        return ConfiguracionPantalla.builder()
                ...
                .temaColor(request.getTemaColor() != null ? request.getTemaColor().trim() : "default")
                .mostrarLogo(request.getMostrarLogo() != null ? request.getMostrarLogo() : true)
                .rutaLogo(request.getRutaLogo() != null ? request.getRutaLogo().trim() : null)
    ...
    public static void updateEntity(ConfiguracionPantalla configuracion, ConfiguracionPantallaRequest request) {
        ...
        if (request.getTemaColor() != null) {
            configuracion.setTemaColor(request.getTemaColor().trim());
        }
        if (request.getMostrarLogo() != null) {
            configuracion.setMostrarLogo(request.getMostrarLogo());
        }
        if (request.getRutaLogo() != null) {
            configuracion.setRutaLogo(request.getRutaLogo().trim());
        }
    }
    ...
    public static ConfiguracionPantallaResponse toResponse(ConfiguracionPantalla configuracion) {
        ...
        return ConfiguracionPantallaResponse.builder()
                ...
                .temaColor(configuracion.getTemaColor())
                .mostrarLogo(configuracion.getMostrarLogo())
                .rutaLogo(configuracion.getRutaLogo())
