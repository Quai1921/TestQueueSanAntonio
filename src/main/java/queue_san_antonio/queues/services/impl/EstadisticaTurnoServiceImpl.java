...
public class EstadisticaTurnoServiceImpl implements EstadisticaTurnoService {
    ...
    public void actualizarTurnoGenerado(Long sectorId, Long empleadoId) {
        ...
        try {
            ...
            log.trace("Estadística actualizada: turno generado en sector {} por empleado {}",
                    sectorId, empleadoId);
    ...
    public void actualizarTurnoAtendido(Long sectorId, Long empleadoId, int tiempoEspera, int tiempoAtencion) {
        if (sectorId == null || empleadoId == null) {
            log.warn("Intento de actualizar estadística de turno atendido con parámetros nulos");
            return;
        }
        ...
        try {
            ...
            estadisticaSector.actualizarTiempoEspera(tiempoEspera);
            estadisticaSector.actualizarTiempoAtencion(tiempoAtencion);
            guardar(estadisticaSector);
