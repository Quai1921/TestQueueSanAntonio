...
public interface TurnoService {
    ...
    Turno llamarTurno(Long turnoId, Long empleadoId);
    Turno iniciarAtencion(Long turnoId, Long empleadoId);
    Turno finalizarAtencion(Long turnoId, String observaciones);
    Turno marcarAusente(Long turnoId, Long empleadoId);

    // Redirección
    Turno redirigirTurno(Long turnoId, Long nuevoSectorId, String motivo, Long empleadoId);
